...
function JSXExamples(){
    ...
    const user = {
        firstName: 'ศิริวุฒิ',
        lastName: 'ชัยเกียรติธรรม',
        age: 20,
        hobbies: ['เล่นเกม','ฟังเพลง','เที่ยว']
    };
        ...
        <div className="jsx-examples">
            ...
            <section>
                ...
                <div className="product-list">
                    <h3>รายการสินค้า</h3>
                    {[
                        { id: 1, name: 'คอมพิวเตอร์', price: 48000, inStock: true },
                        { id: 2, name: 'หน้าจอ', price: 4500, inStock: true },
                        { id: 3, name: 'ปลั๊กพ่วง', price: 899, inStock: false }
                    ].map(product => (
